    ...
    <main>
      ...
      <section className="w-full h-[600px] relative bg-collections-image bg-cover bg-top bg-fixed">
        ...
        <div className="flex flex-col lg:flex-row  lg:justify-start lg:items-center ">
          <div className="bg-purple-700 flex flex-col justify-center w-72 h-72 mt-24 lg:w-80 lg:h-80 text-base lg:text-xl gap-2 text-white font-baskerville mx-auto lg:mt-20 lg:px-4 lg:mx-0">
            <h1 className="">
